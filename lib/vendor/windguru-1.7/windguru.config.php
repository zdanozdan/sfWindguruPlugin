...
$WG_config['id_user']    = 0; // YOUR WINDGURU USER ID (IF YOU DO NOT REMEMBER YOUR ID, SEE YOUR SETTINGS PAGE ON WINDGURU.CZ)

$WG_config['lang']    = 'en'; // DEFAULT LANGUAGE VERSION, possible values:
//    'en' = english (default), 
//    'cz' = czech
//    'de' = german
//    'fr' = french
...
$WG_config['encoding']    = ''; // YOUR WEBPAGE ENCODING, FOR EXAMPLE 'UTF-8' ...
...
$WG_config['cache_type'] = 'file'; // CACHE TYPE SETTING - supported values: 'mysql', 'postgresql', 'file'

// Depending on the type you set in $WG_config['cache_type'] you must also edit following options:

// if you use 'file':
$WG_config['cache_dir']                 = '.'; // your file cache directory (default '.' = current directory)
// NOTE: WEBSERVER MUST BE ABLE TO READ FROM AND WRITE TO THAT DIRECTORY!  

// if you use 'mysql':
$WG_config['cache_mysql_host']          = 'localhost'; // mysql database hostname / IP
$WG_config['cache_mysql_port']          = '3306'; // mysql database port (usually 3306)
$WG_config['cache_mysql_user']          = ''; // mysql database username
$WG_config['cache_mysql_password']      = ''; // mysql database password
$WG_config['cache_mysql_dbname']        = ''; // name of your mysql database 
